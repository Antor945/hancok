        ...
        <>
            <div className='bg-[#1F1F1F]'>
                <div className='max-w-container mx-auto '>
                    <div className='md:flex flex-wrap md:pt-[149px] pt-[50px] md:pb-[169px] pb-[50px] justify-between'>
                        <div className='md:w-[309px] '>
                            <div className='mb-[33px] justify-center md:justify-start flex '>
                                <picture>
                                    <img src={logo} alt="" />
                                </picture>
                            </div>
                            <div className='flex justify-center md:justify-start'>
                                ...
                                <p className='text-white text-sm font-pops font-normal ml-[5px]'>
                                    mail@yourcompany.com
                                </p>
                            </div>
                            <div className='flex justify-center md:justify-start mt-[15px] mb-[15px]'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            ...
                            <div className='flex justify-center md:justify-start md:mb-0 mb-10 mt-[35px] gap-5'>
                        ...
                        <div className='mb-[33px] md:w-[200px]  text-center md:text-start'>
                            <div>
                                <h2 className='font-bold text-base text-white mb-[21px]'>Company</h2>
                            </div>
                            <div className='flex flex-col'>
                                <a href="" className='text-white font-pops font-normal  mb-[15px]'>Home</a>
                                <a href="" className='text-white font-pops font-normal mb-[15px]'>About</a>
                                <a href="" className='text-white font-pops font-normal mb-[15px]'>Services</a>
                                <a href="" className='text-white font-pops font-normal'>Gallery</a>
                            </div>

                        </div>
                        <div className='mb-[33px] md:w-[200px] text-center md:text-start'>
                            <div>
                                <h2 className='font-bold text-base text-white mb-[21px]'>Others</h2>
                            </div>
                            <div className='flex flex-col'>
                                <a href="" className='text-white font-pops font-normal  mb-[15px]'>Blog</a>
                                <a href="" className='text-white font-pops font-normal mb-[15px]'>Contact</a>
                                <a href="" className='text-white font-pops font-normal mb-[15px]'>Terms & Conditions</a>
                                <a href="" className='text-white font-pops font-normal'>Privacy Policy</a>
                            </div>

                        </div>
                        <div className='mb-[33px] md:w-[200px] text-center md:text-start'>
                            <div>
                                <h2 className='font-bold text-base text-white mb-[21px]'>Certificate</h2>
                            </div>
            ...
            <div className='bg-[#282828]'>
                <div className='max-w-container mx-auto '>
                    <h2 className='text-[#6C6C6C] font-pops text-base py-[43px] px-10 md:px-0 text-center'>
